...
<div class='row'>
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
			<div class='php-comment-output'> This is a placeholder for where php generated comments by users will go</div>
			<form class='user-comment-box' name='Portsmouth_NH' method='post' action=''>
...
<div class='row'>
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
			<div class='php-comment-output'> This is a placeholder for where php generated comments by users will go
			</div>
			<form class='user-comment-box' name='Hampton_Beach_NH' method='post' action=''>
			<input type="text" class="form-control" placeholder="Text input">
			<div class='button-holder'>
			<input type='submit' name='submit' value='Submit'></input>
			</form>
...
<div class='row'>
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
			...
			<form class='user-comment-box' name='North_Conway_NH' method='post' action=''>
			<input type="text" class="form-control" placeholder="Text input">
			<div class='button-holder'>
			<input type='submit' name='submit' value='Submit'></input>
			</form>
...
<div class='row'>
	...
	<div class='col-md-6'>
			<div class='comment-box'>	
				...
				<form class='user-comment-box' name='Millinockett_ME' method='post' action=''>
				<input type="text" class="form-control" placeholder="Text input">
				<div class='button-holder'>
				<input type='submit' name='submit' value='Submit'></input>
				</form>
...
<div class='row'>
	...
	<div class='col-md-6'>
				...
				<form class='user-comment-box' name='Bar_Harbor_ME' method='post' action=''>
				<input type="text" class="form-control" placeholder="Text input">
				<div class='button-holder'>
				<input type='submit' name='submit' value='Submit'></input>
				</form>
...
<div class='row'>
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
				...
				<form class='user-comment-box' name='Sugarloaf_ME' method='post' action=''>
				<input type="text" class="form-control" placeholder="Text input">
				<div class='button-holder'>
				<input type='submit' name='submit' value='Submit'></input>
				</form>
...
<div class='row'>
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
				...
				<form class='user-comment-box' name='Sunday_River_ME' method='post' action=''>
				<input type="text" class="form-control" placeholder="Text input">
				<div class='button-holder'>
				<input type='submit' name='submit' value='Submit'></input>
				</form>
...
<div class='row'>
	<div class='col-md-6'>
		...
		to the town as 'northern Massachussetts' because of how close it is to Boston. People start coming here as earlys memorial day, and continue coming until all the leaves have fallen off the trees. Ogunquit’s Marginal Way,
	...
	<div class='col-md-6'>
		<div class='comment-box'>	
				...
				<form class='user-comment-box' name='Ogunquit_ME' method='post' action=''>
				<input type="text" class="form-control" placeholder="Text input">
				<div class='button-holder'>
				<input type='submit' name='submit' value='Submit'></input>
				</form>
...
<!-- FORMAT FOR NEW LOCATION ENTRIES -->
<!--
<div class = 'row'>
	<div class='col-md-12'>
		<p class='text-center h1'>TOWN</p>
	</div>
</div>
<div class='row'>
	<div class='col-md-12'>
		<img class='img-responsive center-block' src='SOURCE' alt='ALT'/>
	</div>
</div>
<br/>
<div class='row'>
	...
	<div class='col-md-6'>
		<p class='text-center'>
MAIN PARAGRAPH ABOUT TOWN
		</p>
		<ul>
			<li><a href='LINK'>NAME OF WEBSITE</a> BRIEF DESCRIPTION</li>
			<li><a href='LINK'>NAME OF WEBSITE</a>BRIEF DESCRIPTION</li>
		</ul>
	</div>
	<div class='col-md-3'>
